    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="menu-header"><i class="fas fa-home"></i><span> Menu Utama</span></li>
            <li class="nav-item{{ request()->is('member') ? ' active' : '' }}"><a href="{{ url('/member') }}"><i class="fas fa-user-friends"></i><span>Member</span></a></li>
            <li class="nav-item{{ request()->is('datalaundrymember') ? ' active' : '' }}"><a href="{{ url('/datalaundrymember') }}"><i class="fas fa-chalkboard-teacher"></i><span>Data Laundry Member</span></a></li>
            <li class="nav-item{{ request()->is('datalaundrynonmember') ? ' active' : '' }}"><a href="{{ url('/datalaundrynonmember') }}"><i class="fas fa-chalkboard"></i><span>Data Laundry Non Member</span></a></li>
            <li class="nav-item{{ request()->is('barang') ? ' active' : '' }}"><a href="{{ url('/barang') }}"><i class="fas fa-box"></i><span> Barang</span></a></li>
            <li class="nav-item{{ request()->is('pembelianbarang') ? ' active' : '' }}"><a href="{{ url('/pembelianbarang') }}"><i class="fas fa-box"></i><span> Pembelian Barang</span></a></li>
            <li class="nav-item{{ request()->is('pegawai') ? ' active' : '' }}"><a href="{{ url('/pegawai') }}"><i class="fas fa-users"></i><span>Pegawai</span></a></li>
          </ul>
          </li>
          </ul>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2024 <div class="bullet"></div> Design By <a href="https://nauval.in/">Darwiansyah</a>
        </div>
